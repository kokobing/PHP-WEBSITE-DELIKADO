...
if(isset($_POST[button_ok]) && $onuserperm_editprem=='1'){//修改
	...
	smailboxpass='".$_POST[smailboxpass]."',icp='".$_POST[icp]."',mapcode='".$_POST[mapcode]."',iscopy='".$_POST[iscopy]."',isstyle='".$_POST[isstyle]."',weburl='".$_POST[weburl]."',productnum='".$_POST[productnum]."',newsnum='".$_POST[newsnum]."',bannertime='".$_POST[bannertime]."',pagetransition='".$_POST[pagetransition]."' where id_siteset='1'";
