...
$strSQL = "select iscopy,otherheader,title,keywords,description,icp,mapcode,statistics,weburl,newsnum,productnum,bannertime,rmailbox as mail,smailbox as tel,pagetransition from siteset where id_siteset=1" ;
$objDB->Execute($strSQL);
$setinfo=$objDB->fields();


//if( $_SERVER['HTTP_REFERER']=='http://dc:7102/screenfly/' && !isset($_SESSION[tackcomein]) ){$_SESSION[tackcomein]=1;};
